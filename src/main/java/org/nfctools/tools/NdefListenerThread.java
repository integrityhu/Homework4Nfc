...
import org.nfctools.tools.json.NdefOperationsMessage;
import org.nfctools.tools.ndef.BuilderConfig;
import org.nfctools.tools.ndef.MapBuilder;
...
import hu.infokristaly.homework4ndef.NDefMessageListener;
...
public class NdefListenerThread implements Runnable, NdefListener, TerminalStatusListener, NdefOperationsListener,
    ...
    private NDefMessageListener ndefApplet;

    private NdefOperations lastNdefOperations;

    public NdefListenerThread(NDefMessageListener ndefApplet) {
